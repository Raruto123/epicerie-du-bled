...
export default function OnboardingScreen({navigation}) {
    ...
    return(
        <View style={{flex : 1, backgroundColor : "white"}}>
            {/* Header actions */}
            <View style={{paddingTop : 50, paddingHorizontal : 20, flexDirection : 'row', justifyContent : "center"}}>
            ...
            <View style={{padding : 20}}>
                ...
                <Pressable
                    ...
                    {isLast && (
                        <Pressable onPress={skip} style={{paddingVertical : 12, alignItems : "center"}}>
